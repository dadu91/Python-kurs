const liste = {
  ...
  goals: [
    "Razumiješ šta je lista u Pythonu",
    "Znaš kako se pravi lista",
    "Umiješ da pristupiš elementu liste pomoću indeksa",
    "Znaš kako se dodaje novi element u listu",
    "Znaš kako se prolazi kroz listu pomoću for petlje",
    "Umiješ da koristiš len() i sum() nad listom brojeva",
  ],

...
UPDATE lekcija SET redoslijed = 8 WHERE naziv = 'Skupovi i Tuple';
UPDATE lekcija SET redoslijed = 9 WHERE naziv = 'Rječnici u Pythonu';


DELETE FROM zadatak 
WHERE lekcija_id = (SELECT id FROM lekcija WHERE naziv = 'Uvod u Python') 
AND redoslijed = 6;

UPDATE lekcija SET redoslijed = 3 WHERE naziv LIKE '%slovi%';
UPDATE lekcija SET redoslijed = 5 WHERE naziv LIKE '%iste%';
UPDATE lekcija SET redoslijed = 6 WHERE naziv LIKE '%tring%';

SELECT id, naziv, redoslijed FROM lekcija ORDER BY redoslijed;

UPDATE lekcija SET redoslijed = 3 WHERE id = 18;
UPDATE lekcija SET redoslijed = 4 WHERE id = 4;
UPDATE lekcija SET redoslijed = 5 WHERE id = 3;
UPDATE lekcija SET redoslijed = 6 WHERE id = 5;